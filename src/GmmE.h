...
public:
  ...
  arma::mat delta_swap(const int i,int K, const arma::vec cl, arma::uvec iclust);
  void swap_update(const int i,const arma::vec cl,bool dead_cluster,const int newcl);
