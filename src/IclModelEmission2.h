#ifndef ICLMODELEMISSION2
#define ICLMODELEMISSION2
...
public:
  ...
  virtual arma::mat delta_swap(const int i,arma::vec & cl,bool dead_cluster, arma::uvec iclust,int K){return NULL;};
  // update the stats when a node is swapped
  virtual void swap_update(const int i,arma::vec & cl,bool dead_cluster,const int newcl){};
