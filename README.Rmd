...
* Stochastic Block Models (for directed and un-directed graphs, see ``?`sbm-class` ``), 
* Degree Corrected Stochastic Block Models (for directed and un-directed graphs, see ``?`dcsbm-class` ``),
* Stochastic Block Models with Mutlinomial observations (experimental, see `?multsbm-class`),
