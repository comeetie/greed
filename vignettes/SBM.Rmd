...
> **Practicalities:** A `CombinedModels` with `SbmPrior` or `DcSbmPrior` views will use a sparse representation of the differents views and will therefore scale well with the network size.
