...
th = theme_classic(base_size = 20) %+replace%
  ggplot2::theme(
...
```{r test-plot}
# gg = ggplot(cars) + geom_point(aes(x=speed, y=dist)) + ggtitle('cars')
# gg
```
...
# cat('An ARI of ', aricode::ARI(diabetes$class, clustering(sol)))
```
...
Finally, the clusters centers look coherent and the hierarchical ordering underlines a form of "geometric proximities" between clusters.
