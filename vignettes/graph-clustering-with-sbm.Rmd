...
```{r, fig.show='hold',out.width="70%",fig.width=8,fig.height=5.5}
data("Xpolbooks")
solpol=fit(Xpolbooks,5,new("dcsbm"),new("genetic",pop_size=30))
...
```{r, fig.show='hold',out.width="70%",fig.width=8,fig.height=5.5}
data("Xpolblogs")
solblogs=fit(Xpolblogs,25,new("dcsbm"),new("km"))
...
```{r, fig.show='hold',out.width="70%",fig.width=8,fig.height=5.5}
solblogsgen =fit(Xpolblogs,25,new("dcsbm"),new("genetic",pop_size=20))
solblogsgen@icl-solblogs@icl
```